...
## The ElderCrank Philosophy
* **No-Nonsense Namespacing:** Everything lives under the `eldercrank` namespace.
* **Modern Plumbing:** Built for Python 3.13+ using `uv` and `hatchling`.
* **Zero Patience for Flaky APIs:** If it's in here, it's been vetted.
